...
#       temporary focusing on currentworking.
#
##############################################################################
...
# and target Java 8 for compatibility
DEFAULT_JVM_OPTS="$DEFAULT_JVM_OPTS \"-Dfile.encoding=UTF-8\" \"-Dsun.stdout.encoding=UTF-8\" \"-Dsun.stderr.encoding=UTF-8\""
